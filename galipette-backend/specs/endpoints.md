...
|----------------------------------|---------------------------------------------|-------------------------------|
| `GET /players?fields=...`        | List all players                            | Filter by `ids=1,2,3`, campaignId, playerId         |
| `GET /players/:id?fields=...`    | Get details of a player                     |                               |
| `POST /players`                  | Create a new player                         |                               |
| `PATCH /players/:id`             | Update player information                   |                               |
